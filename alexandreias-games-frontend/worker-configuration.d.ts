/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 4c0c5882106aa4909d50987a58b75f80)
// Runtime types generated with workerd@1.20260721.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT?: "preview" | "production";
	"alexandreias-games-backend": Fetcher /* alexandreias-games-backend-staging */ | Fetcher /* alexandreias-games-backend-production */ | Fetcher /* alexandreias-games-backend */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		ENVIRONMENT: "preview";
		"alexandreias-games-backend": Fetcher /* alexandreias-games-backend-staging */;
	}
	interface ProductionEnv {
		ENVIRONMENT: "production";
		"alexandreias-games-backend": Fetcher /* alexandreias-games-backend-production */;
	}
